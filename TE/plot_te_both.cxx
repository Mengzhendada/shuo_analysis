...
#include <locale>
  void plot_te_both(){
        ...
        for(auto it_neg = runjs["neg"].begin();it_neg!=runjs["neg"].end();it_neg++){
          ...
          if(std::isdigit(neg_key[0])){
            ...
            if(ik_neg.find("data_n") != ik_neg.end() && ik_neg.find("SHMS_pi_expected") != ik_neg.end() && ik_neg.find("time") != ik_neg.end() && ik_neg.find("start_time")!= ik_neg.end()){
              ...
              double yield = pi_expected/(charge*te);
   ...
   // c_te_all->SaveAs(c_te_all_name.c_str());
    ...
    std::string c_te_all_runs_name = "results/TE/pi_te_both_runs.pdf";
    ...
    std::string c_te_all_realtime_name = "results/TE/pi_te_both_realtime.pdf";
    ...
    std::string c_te_all_realtime_ratecorr_name = "results/TE/pi_te_both_realtime_ratecorr.pdf";
    ...
    std::string c_te_momentum_name = "results/TE/pi_te_both_momentum.pdf";
    ...
    std::string c_te_momentum_ratecorr_name = "results/TE/pi_te_momentum_both_ratecorr.pdf";
    ...
    std::string c_te_index_name =  "results/TE/pi_te_index_both.pdf";
