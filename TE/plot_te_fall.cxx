...
#include <locale>
  void plot_te_fall(){
   ...
   // c_te_all->SaveAs(c_te_all_name.c_str());
    ...
    std::string c_te_all_yield_name = "results/TE/pi_te_fall_vs_yield.pdf";
  ...
  //  neg_fit->FixParameter(0,1);
    ...
    std::string c_te_all_rate_name = "results/TE/pi_te_fall_vs_rate.pdf";
    ...
    std::string c_te_all_ratecorr_name = "results/TE/pi_te_fall_vs_rate_ratecorr.pdf";
    ...
    std::string c_te_all_yieldte_name = "results/TE/pi_te_fall_yieldte.pdf";
    ...
    std::string c_te_all_yieldteratecorr_name = "results/TE/pi_te_fall_yieldteratecorr.pdf";
    ...
    std::string c_te_all_yieldrate_name = "results/TE/pi_te_fall_vs_yieldrate.pdf";
    ...
    std::string c_te_all_runs_name = "results/TE/pi_te_fall_runs.pdf";
    ...
    std::string c_te_all_realtime_name = "results/TE/pi_te_fall_realtime.pdf";
    ...
    std::string c_te_all_realtime_ratecorr_name = "results/TE/pi_te_fall_realtime_ratecorr.pdf";
    ...
    std::string c_te_momentum_name = "results/TE/pi_te_fall_momentum.pdf";
    ...
    std::string c_te_momentum_ratecorr_name = "results/TE/pi_te_momentum_fall_ratecorr.pdf";
    ...
    std::string c_te_index_name =  "results/TE/pi_te_index_fall.pdf";
    ...
    std::string c_te_index_ratecorr_name =  "results/TE/pi_te_index_fall_ratecorr.pdf";
