      ...
      if(!neg_D2.empty() && !pos_D2.empty()){
        for(auto i_neg = neg_D2.begin();i_neg!=neg_D2.end();i_neg++){
          ...
          if(RunNumber<7000){
            ...
            g_neg_fall_HMSTE_rate->SetPoint(i_fall_neg_TE,rate,HMSTE);
            i_fall_neg_TE++;
          }
          else{
            g_neg_spring_TE_rate->SetPoint(i_spring_neg_TE,rate,TE);
            g_neg_spring_HMSTE_rate->SetPoint(i_spring_neg_TE,rate,HMSTE);
            i_spring_neg_TE++;
        ...
        for(auto i_pos = pos_D2.begin();i_pos!=pos_D2.end();i_pos++){
          ...
          if(RunNumber<7000){
            ...
            g_pos_fall_HMSTE_rate->SetPoint(i_fall_pos_TE,rate,HMSTE);
            i_fall_pos_TE++;
          }
          else{
            g_pos_spring_TE_rate->SetPoint(i_spring_pos_TE,rate,TE);
            g_pos_spring_HMSTE_rate->SetPoint(i_spring_pos_TE,rate,HMSTE);
            i_spring_pos_TE++;
