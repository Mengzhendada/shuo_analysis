...
#include <vector>
#include <map>
//instead of subtract delta exc rho from data, I add it to the simc inc rad yield, then take simc yield ratio

void acceptance_sys_simcsubstract(){
  json j_Q2x;
  {
  ...
  int i_whichx = 0; 
  json jout;
  std::ofstream file("results/acceptance1/SHMS_p0file_simcsubstract.txt");
      ...
      if(xbj !=0 && Q2!=0){  
        for(json::iterator it = j_z.begin();it!=j_z.end();++it){
          ...
          */  
          ...
          std::string c_yield_pos_name = "results/acceptance1/"+q2xz_str_filename+"_yield_pos.pdf";
          ...
          std::string c_yield_neg_name = "results/acceptance1/"+q2xz_str_filename+"_yield_neg.pdf";
          ...
          */
          ...
          //for(int i = 0;i<nbins_sim;i++){
            ...
            double y_sim_neg_incrad = h_shmsdp_neg_sim_incrad->GetBinContent(i+1);
            double y_sim_pos_incrad = h_shmsdp_pos_sim_incrad->GetBinContent(i+1);
          ...
          std::string zratiopdfname = "results/acceptance1/"+q2xz_str_filename+"_ratio.pdf";
          ...
          std::string c_data_simc_ratio_name = "results/acceptance1/"+q2xz_str_filename+"_datasimcratio.pdf";
...
g_p0->Draw("AP");
c_p0->SaveAs("results/acceptance/SHMS_p0_simcsubstract.pdf");
...
g_p0_z->Draw("AP");
c_p0_z->SaveAs("results/acceptance/SHMS_p0_z_simcsubstract.pdf");
