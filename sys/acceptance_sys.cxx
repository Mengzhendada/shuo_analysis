    ...
    for(json::iterator it  = j_Q2z.begin();it!=j_Q2z.end();++it){
      ...
      if(xbj !=0 && Q2!=0){  
        for(json::iterator it = j_z.begin();it!=j_z.end();++it){
          ...
          TH1D* h_shmsdp_neg_all = new TH1D("","neg;z;",100,-10,20);
          ...
          TH1D* h_shmsdp_pos_all = new TH1D("","pos;z;",100,-10,20);
          ...
          TH1D* h_shmsdp_neg_bg_all = new TH1D("","neg bg;z;",100,-10,20);
          //THStack *h_shmsdp_neg_all = new THStack("","");  
          h_shmsdp_neg_bg_all->GetXaxis()->SetTitle("shmsdp");
          //h_shmsdp_neg_bg_all->GetYaxis()->SetTitle("bg counts");
          //h_shmsdp_neg_all->GetYaxis()->SetRangeUser(0,2);
          TH1D* h_shmsdp_pos_bg_all = new TH1D("","pos bg;z;",100,-10,20);
          //THStack *h_shmsdp_pos_all = new THStack("","");
          ...
          TH1D *h_shmsdp_neg_sim = new TH1D("","pi- sim sum",100,-10,20);
          TH1D *h_shmsdp_neg_sim_incrad = new TH1D("","pi- sim SIDIS",100,-10,20);
          ...
          TH1D *h_shmsdp_pos_sim = new TH1D("","pi+ sim sum",100,-10,20);
          TH1D *h_shmsdp_pos_sim_incrad = new TH1D("","pi+ sim SIDIS",100,-10,20);
          ...
          if(z!=0){
            ...
            for(auto it = neg_D2_runs.begin();it!=neg_D2_runs.end();++it){
              ...
              TH1D *h_shmsdp_neg = new TH1D("","",100,-10,20);
              h_shmsdp_neg = (TH1D*)root_file_neg->Get("shmsdp");
              TH1D *h_shmsdp_neg_bg = new TH1D("","",100,-10,20);
            ...
            for(auto it = pos_D2_runs.begin();it!=pos_D2_runs.end();++it){
              ...
              TH1D *h_shmsdp_pos = new TH1D("","",100,-10,20);
              h_shmsdp_pos = (TH1D*)root_file_pos->Get("shmsdp");
              TH1D *h_shmsdp_pos_bg = new TH1D("","",100,-10,20);
