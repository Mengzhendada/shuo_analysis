...
void plot_kinematic_events(int RunNumber = 7593){
   ...
   if(!root_file_exists(rootfile_name)){
     std::cout<< rootfile_name <<" not found!\n";
   }
 ...
 //  auto dCoin_sidis_pion_intime = dCOIN_sidis.Filter(timing_cut);
   ...
   c->SaveAs(name.c_str());
   TFile* root = new TFile("results/csv_kin/kinematics.root","UPDATE");
