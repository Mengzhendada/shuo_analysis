...
void SHMS_rftime_plot(){
  ...
  for(auto it = j_rungroup.begin();it!=j_rungroup.end();++it){
    ...
    if(!pos_D2.empty() && !neg_D2.empty()){
      ...
      if(shms_p>2.8){
        ...
        for(auto ik = point_js.begin();ik!=point_js.end();++ik){
          ...
          if(RunGroup<410 && HGC_eff_pos_err<0.2 && xbj>0.5){
          ...
          else if(HGC_eff_pos_err<0.2 && xbj>0.5){
    ...
    c_HGCeff_xbj->SaveAs("results/pid/HGC_pid/HGCeff_xbj.pdf");
    ...
    c_HGCeff_shmsdp->SaveAs("results/pid/HGC_pid/HGCeff_shmsdp.pdf");
    ...
    c_Kpiratio_xbj->SaveAs("results/pid/HGC_pid/Kpiratio_xbj.pdf");
    ...
    c_Kpiratio_shmsdp->SaveAs("results/pid/HGC_pid/Kpiratio_shmsdp.pdf");
    ...
    c_Kratio_xbj->SaveAs("results/pid/HGC_pid/Kratio_xbj.pdf");
    ...
    c_Kratio_shmsdp->SaveAs("results/pid/HGC_pid/Kratio_shmsdp.pdf");
    ...
    c_piratio_xbj->SaveAs("results/pid/HGC_pid/piratio_xbj.pdf");
    ...
    c_piratio_shmsdp->SaveAs("results/pid/HGC_pid/piratio_shmsdp.pdf");
  }
