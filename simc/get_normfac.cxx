...
void get_normfac(int RunGroup = 0){
  ...
  std::string hist_D2_neg_K_inc_rad_name    = path+"outfiles/csv_"+std::to_string(RunGroup)+"_D2_neg_k_inc_rad.hist";
  ...
  std::string hist_D2_pos_K_inc_rad_name    = path+"outfiles/csv_"+std::to_string(RunGroup)+"_D2_pos_K_inc_rad.hist";
  ...
  D2_neg_K_inc_rad.open(hist_D2_neg_K_inc_rad_name.c_str());
  ...
  D2_pos_K_inc_rad.open(hist_D2_pos_K_inc_rad_name.c_str());
  ...
  H2_neg_K_inc_rad.open(hist_H2_neg_K_inc_rad_name.c_str());
  ...
  H2_pos_K_inc_rad.open(hist_H2_pos_K_inc_rad_name.c_str());
  ...
  line = "";
  while(std::getline(D2_neg_K_inc_rad,line)){
    if(line.find(normfac)<line.length()){
      std::cout<<line<<std::endl;
      size_t i = 0;
      for(;i < line.length();i++){ if(isdigit(line[i])) break; }
  ...
  line = "";
  while(std::getline(D2_pos_K_inc_rad,line)){
    if(line.find(normfac)<line.length()){
      std::cout<<line<<std::endl;
      size_t i = 0;
      for(;i < line.length();i++){ if(isdigit(line[i])) break; }
  ...
  line = "";
  while(std::getline(H2_neg_K_inc_rad,line)){
    if(line.find(normfac)<line.length()){
      std::cout<<line<<std::endl;
      size_t i = 0;
      for(;i < line.length();i++){ if(isdigit(line[i])) break; }
  ...
  line = "";
  while(std::getline(H2_pos_K_inc_rad,line)){
    if(line.find(normfac)<line.length()){
      std::cout<<line<<std::endl;
      size_t i = 0;
      for(;i < line.length();i++){ if(isdigit(line[i])) break; }
