...
do
  ...
  #echo csv_${i}_H2_neg_K_inc_rad | ./make_root_tree
  #echo csv_${i}_H2_pos_K_inc_rad | ./make_root_tree
  #echo csv_${i}_D2_neg_K_inc_rad | ./make_root_tree
  #echo csv_${i}_D2_pos_K_inc_rad | ./make_root_tree
done
