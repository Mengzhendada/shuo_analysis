...
echo csv_380_H2_neg_inc_norad | ./simc
echo csv_380_H2_neg_inc_rad | ./simc
echo csv_380_H2_neg_rho | ./simc
echo csv_380_H2_neg_delta | ./simc
echo csv_380_H2_pos_inc_norad | ./simc
echo csv_380_H2_pos_inc_rad | ./simc
echo csv_380_H2_pos_exc_rad | ./simc
echo csv_380_H2_pos_rho | ./simc
echo csv_380_H2_pos_delta | ./simc
