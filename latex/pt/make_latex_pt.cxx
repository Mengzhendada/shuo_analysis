...
void make_latex_pt(){
  ...
  for(json::iterator it = j_Q2x.begin();it!=j_Q2x.end();++it){
    ...
    for(json::iterator i_Q2 = j_Q2z.begin();i_Q2!=j_Q2z.end();++i_Q2){
      ...
      if(xbj!=0 && Q2!=0){
        std::string q2x_str = "x\\_Q2\\_"+std::to_string(xbj).substr(0,4)+"\\_"+std::to_string(Q2).substr(0,5);
        ...
        ofs<<"\\includegraphics[width = 0.9\\textwidth]{results/pt/polar_neg_"<<counts_z_name[0]<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.9\\textwidth]{results/pt/polar_neg_"<<counts_z_name[1]<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\end{columns}"<<std::endl;
        if(counts_z_name.size()>2){
          ofs<<"\\begin{columns}"<<std::endl;
          ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
          ofs<<"\\includegraphics[width = 0.9\\textwidth]{results/pt/polar_neg_"<<counts_z_name[2]<<".pdf}"<<std::endl;
        ...
        ofs<<"\\begin{columns}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.9\\textwidth]{results/pt/polar_pos_"<<counts_z_name[0]<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.9\\textwidth]{results/pt/polar_pos_"<<counts_z_name[1]<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\end{columns}"<<std::endl;
        if(counts_z_name.size()>2){
          ofs<<"\\begin{columns}"<<std::endl;
          ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
          ofs<<"\\includegraphics[width = 0.9\\textwidth]{results/pt/polar_pos_"<<counts_z_name[2]<<".pdf}"<<std::endl;
        ...
        ofs<<"\\begin{columns}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.7\\textwidth]{results/pt/phi_neg_"<<std::to_string(neg_D2_z[0])<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.7\\textwidth]{results/pt/th_neg_"<<std::to_string(neg_D2_z[0])<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\end{columns}"<<std::endl;
        ofs<<"\\begin{columns}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.7\\textwidth]{results/pt/pt_neg_"<<std::to_string(neg_D2_z[0])<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\end{columns}"<<std::endl;
        ...
        ofs<<"\\begin{columns}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.7\\textwidth]{results/pt/phi_pos_"<<std::to_string(pos_D2_z[0])<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.7\\textwidth]{results/pt/th_pos_"<<std::to_string(pos_D2_z[0])<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\end{columns}"<<std::endl;
        ofs<<"\\begin{columns}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\includegraphics[width = 0.7\\textwidth]{results/pt/pt_pos_"<<std::to_string(pos_D2_z[0])<<".pdf}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\begin{column}[T]{0.5\\textwidth}"<<std::endl;
        ofs<<"\\end{column}"<<std::endl;
        ofs<<"\\end{columns}"<<std::endl;
