...
void kin_acceptance(int Rungroup = 0){
  ...
  int warmcolor[5] = {2,6,46,45,44};
    ...
    for(std::vector<int>::iterator it = neg_runs.begin();it!= neg_runs.end();++it){
      ...
      //    xq2_box->Draw("l");
      std::string xq2filename = "results/csv_kin/kin_acceptance/x_Q2_neg_"+std::to_string(Rungroup)+".pdf";
 ...
 // c_shms_prime->SaveAs(shms_prime_filename.c_str());
    ...
    std::string pion_momentum_name = "results/csv_kin/kin_acceptance/kin_neg_acceptance_"+std::to_string(Rungroup)+".pdf";
    ...
    std::string pion_cut_name = "results/csv_kin/kin_acceptance/kin_neg_acceptance_cuts"+std::to_string(Rungroup)+".pdf";
    ...
    c_xbj->BuildLegend();
    std::string c_xbj_name = "results/csv_kin/kin_acceptance/xbj_neg_cuts_"+std::to_string(Rungroup)+".pdf";
    ...
    c_q2->BuildLegend();
    std::string c_q2_name = "results/csv_kin/kin_acceptance/q2_neg_cuts_"+std::to_string(Rungroup)+".pdf";
    ...
    std::string c_Wprime_name = "results/csv_kin/kin_acceptance/Wprime_neg_cuts_"+std::to_string(Rungroup)+".pdf";
    ...
    c_z->BuildLegend();
    std::string c_z_name = "results/csv_kin/kin_acceptance/z_neg_cuts_"+std::to_string(Rungroup)+".pdf";
    ...
    std::string pion_cut_name_pos = "results/csv_kin/kin_acceptance/kin_pos_acceptance_cuts"+std::to_string(Rungroup)+".pdf";
    ...
    h_xbj_xq2cut_pos->SetLineColor(coolcolor[0]);
    h_xbj_xq2cut_pos->Write();
    h_xbj_xq2cut_pos->DrawCopy();
    h_xbj_cut1_pos->SetLineColor(coolcolor[1]);
    h_xbj_cut1_pos->Write();
    h_xbj_cut1_pos->DrawCopy("same");
    h_xbj_cut2_pos->SetLineColor(coolcolor[2]);
    h_xbj_cut2_pos->Write();
    h_xbj_cut2_pos->DrawCopy("same");
    h_xbj_cut3_pos->SetLineColor(coolcolor[3]);
    h_xbj_cut3_pos->Write();
    h_xbj_cut3_pos->DrawCopy("same");
    c_xbj_pos->BuildLegend();
    std::string c_xbj_name_pos = "results/csv_kin/kin_acceptance/xbj_pos_cuts_"+std::to_string(Rungroup)+".pdf";
    c_xbj_pos->SaveAs(c_xbj_name_pos.c_str());

    TCanvas *c_q2_pos = new TCanvas();
    h_q2_xq2cut_pos->SetLineColor(coolcolor[0]);
    h_q2_xq2cut_pos->Write();
    h_q2_xq2cut_pos->DrawCopy();
    h_q2_cut1_pos->SetLineColor(coolcolor[1]);
    h_q2_cut1_pos->Write();
    h_q2_cut1_pos->DrawCopy("same");
    h_q2_cut2_pos->SetLineColor(coolcolor[2]);
    h_q2_cut2_pos->Write();
    h_q2_cut2_pos->DrawCopy("same");
    h_q2_cut3_pos->SetLineColor(coolcolor[3]);
    h_q2_cut3_pos->Write();
    h_q2_cut3_pos->DrawCopy("same");
    c_q2_pos->BuildLegend();
    std::string c_q2_name_pos = "results/csv_kin/kin_acceptance/q2_pos_cuts_"+std::to_string(Rungroup)+".pdf";
    c_q2_pos->SaveAs(c_q2_name_pos.c_str());

    TCanvas *c_Wprime_pos = new TCanvas();
    h_Wprime_xq2cut_pos->SetLineColor(coolcolor[0]);
    h_Wprime_xq2cut_pos->Write();
    h_Wprime_xq2cut_pos->DrawCopy();
    h_Wprime_cut1_pos->SetLineColor(coolcolor[1]);
    h_Wprime_cut1_pos->Write();
    h_Wprime_cut1_pos->DrawCopy("same");
    h_Wprime_cut2_pos->SetLineColor(coolcolor[2]);
    h_Wprime_cut2_pos->Write();
    h_Wprime_cut2_pos->DrawCopy("same");
    h_Wprime_cut3_pos->SetLineColor(coolcolor[3]);
    h_Wprime_cut3_pos->Write();
    h_Wprime_cut3_pos->DrawCopy("same");
    c_Wprime_pos->BuildLegend();
    std::string c_Wprime_name_pos = "results/csv_kin/kin_acceptance/Wprime_pos_cuts_"+std::to_string(Rungroup)+".pdf";
    c_Wprime_pos->SaveAs(c_xbj_name_pos.c_str());

    TCanvas *c_z_pos = new TCanvas();
    h_z_xq2cut_pos->SetLineColor(coolcolor[0]);
    h_z_xq2cut_pos->Write();
    h_z_xq2cut_pos->DrawCopy();
    h_z_cut1_pos->SetLineColor(coolcolor[1]);
    h_z_cut1_pos->Write();
    h_z_cut1_pos->DrawCopy("same");
    h_z_cut2_pos->SetLineColor(coolcolor[2]);
    h_z_cut2_pos->Write();
    h_z_cut2_pos->DrawCopy("same");
    h_z_cut3_pos->SetLineColor(coolcolor[3]);
    h_z_cut3_pos->Write();
    h_z_cut3_pos->DrawCopy("same");
    c_z_pos->BuildLegend();
    std::string c_z_name_pos = "results/csv_kin/kin_acceptance/z_pos_cuts_"+std::to_string(Rungroup)+".pdf";
