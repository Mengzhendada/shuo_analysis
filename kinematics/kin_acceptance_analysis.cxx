...
std::string c_xbj_xq2cut_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_xbj_nocut.pdf";
...
std::string c_xbj_cut1_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_xbj_cut1.pdf";
...
std::string c_xbj_cut2_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_xbj_cut2.pdf";
...
std::string c_xbj_cut3_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_xbj_cut3.pdf";
...
//compare neg runs xbj with different cut, no cut and cut1
    ...
    std::string c_xbj_xq2_cut1_name = "results/csv_kin/kin_acceptance/xbj_neg_xq2cut_cut1_"+std::to_string(Rungroup)+".pdf";
    ...
    std::string c_xbj_cut3_cut1_name = "results/csv_kin/kin_acceptance/xbj_neg_cut3_cut1_"+std::to_string(Rungroup)+".pdf";
...
std::string c_z_xq2cut_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_z_nocut.pdf";
...
std::string c_z_cut1_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_z_cut1.pdf";
...
std::string c_z_cut2_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_z_cut2.pdf";
...
std::string c_z_cut3_name = "results/csv_kin/kin_acceptance/compare_"+std::to_string(Rungroup)+"_z_cut3.pdf";
c_z_cut3->SaveAs(c_z_cut3_name.c_str());
    ...
    c_z_xq2_cut1->Update();
    std::string c_z_xq2_cut1_name = "results/csv_kin/kin_acceptance/z_xq2cut_cut1_"+std::to_string(Rungroup)+".pdf";
    ...
    std::string c_z_cut3_cut1_name = "results/csv_kin/kin_acceptance/z_cut3_cut1_"+std::to_string(Rungroup)+".pdf";
