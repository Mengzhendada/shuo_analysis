  ...
  if(!neg_Dummy.empty() && !pos_Dummy.empty()){
   ...
   //   ;
    ...
    for(auto it = pos_Dummy.begin();it!=pos_Dummy.end();++it){
      ...
      opts.fMode = "UPDATE";
      d_pos_pi.Snapshot("T",skim_name.c_str(),{"xbj","z","Q2","W2","W","Wp","Wp2","emiss","mmiss","InvMass","Mx2","pmiss","weight","P.gtr.th","P.gtr.ph","P.gtr.y","P.gtr.dp","P.gtr.p","H.gtr.dp","P.kin.secondary.th_xq","P.kin.secondary.ph_xq","H.kin.primary.omega"});
    ...
    //std::cout<<bg_cut<<std::endl;
      ...
      d_pos_bg.Snapshot("T_bg",skim_name.c_str(),{"xbj","z","Q2","W2","W","Wp","Wp2","emiss","mmiss","InvMass","pmiss","Mx2","weight","P.gtr.th","P.gtr.ph","P.gtr.y","P.gtr.dp","P.gtr.p","H.gtr.dp","P.kin.secondary.th_xq","P.kin.secondary.ph_xq","H.kin.primary.omega"},opts);
    ...
    auto h_coin_negcut = d_neg_first.Histo1D({"","",800,0,100},"CTime.ePiCoinTime_ROC2");
      ...
      //= {"UPDATE", ROOT::kZLIB, 0, 0, 99, true};
      opts.fMode = "UPDATE";
      d_neg_pi.Snapshot("T",skim_name.c_str(),{"xbj","z","Q2","W2","W","Wp","Wp2","emiss","mmiss","InvMass","Mx2","pmiss","weight","P.gtr.th","P.gtr.ph","P.gtr.y","P.gtr.dp","P.gtr.p","H.gtr.dp","P.kin.secondary.th_xq","P.kin.secondary.ph_xq","H.kin.primary.omega"});
    ...
    std::cout<<bg_cut<<std::endl;
      ...
      d_neg_bg.Snapshot("T_bg",skim_name.c_str(),{"xbj","z","Q2","W2","W","Wp","Wp2","emiss","mmiss","InvMass","Mx2","pmiss","weight","P.gtr.th","P.gtr.ph","P.gtr.y","P.gtr.dp","P.gtr.p","H.gtr.dp","P.kin.secondary.th_xq","P.kin.secondary.ph_xq","H.kin.primary.omega"},opts);
