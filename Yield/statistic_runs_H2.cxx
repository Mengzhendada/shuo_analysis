...
void statistic_runs_H2(int RunGroup=0){
  ...
  if(!neg_H2.empty() && !pos_H2.empty()){
    ...
    for(auto it = pos_H2.begin();it!=pos_H2.end();++it){
      ...
      h_xbj_bg->Write();
      auto h_xbj_bg_1 = d_pos_bg_1.Histo1D({"xbj_1","xbj_1",bins,0,1},"xbj");
      auto h_xbj_bg_2 = d_pos_bg_2.Histo1D({"xbj_2","xbj_2",bins,0,1},"xbj");
      auto h_xbj_bg_3 = d_pos_bg_3.Histo1D({"xbj_3","xbj_3",bins,0,1},"xbj");
      h_xbj_bg_1->Write();
      h_xbj_bg_2->Write();
      h_xbj_bg_3->Write();
      auto h_xprime_bg_1 = d_pos_bg_1.Histo1D({"xprime_1","xprime_1",bins,0,1},"xprime");
      auto h_xprime_bg_2 = d_pos_bg_2.Histo1D({"xprime_2","xprime_2",bins,0,1},"xprime");
      auto h_xprime_bg_3 = d_pos_bg_3.Histo1D({"xprime_3","xprime_3",bins,0,1},"xprime");
      h_xprime_bg_1->Write();
      h_xprime_bg_2->Write();
      h_xprime_bg_3->Write();
      ...
      h_x_z_bg_2->Write();
      auto h_x_z_pos_3 = d_pos_pi_3.Histo2D({"x_z_3","x_z_3",bins,0,1,bins,0,1},"z","xbj");
      h_x_z_pos_3->Write();
