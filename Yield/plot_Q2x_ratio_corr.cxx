    ...
    for(json::iterator it  = j_Q2z.begin();it!=j_Q2z.end();++it){
      ...
      if(xbj !=0 && Q2!=0){  
        for(json::iterator it = j_z.begin();it!=j_z.end();++it){
          ...
          std::string c_counts_name = "results/yield/statistics_corr/counts_"+q2xz_str+".png";
          ...
          h_z_neg_bg_all->DrawCopy("hist same");
          c_yield->Update();
          std::string c_yield_name = "results/yield/statistics_corr/yield_"+q2xz_str+".png";
        ...
        // }
         ...
         // //h_z_neg_all->Draw();
          ...
          std::string zratiopdfname = "results/yield/statistics_corr/"+canvas_name+"_"+std::to_string(z).substr(0,4)+"_ratio.pdf";
