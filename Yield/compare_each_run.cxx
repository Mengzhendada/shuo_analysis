        ...
        for(json::iterator it = j_z.begin();it!=j_z.end();++it){
          ...
          if(z!=0){
            ...
            for(auto it = neg_D2_runs.begin();it!=neg_D2_runs.end();++it){
              ...
              h_z_neg->Scale(1/(charge*TLT*TE*HMS_cal_eff*HMS_cer_eff*SHMS_cal_eff*SHMS_aero_eff));
              h_z_neg->Add(h_z_neg_bg,-1/(charge*6*TLT*TE*HMS_cal_eff*HMS_cer_eff*SHMS_cal_eff*SHMS_aero_eff));
            ...
            for(auto it = pos_D2_runs.begin();it!=pos_D2_runs.end();++it){
              ...
              h_z_pos->Scale(1/(charge*TLT*TE*HMS_cal_eff*HMS_cer_eff*SHMS_cal_eff*SHMS_aero_eff));
              h_z_pos->Add(h_z_pos_bg,-1/(6*charge*TLT*TE*HMS_cal_eff*HMS_cer_eff*SHMS_cal_eff*SHMS_aero_eff));
