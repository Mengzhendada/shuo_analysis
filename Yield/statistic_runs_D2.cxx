...
void statistic_runs_D2(int RunGroup=0){
  ...
  if(!neg_D2.empty() && !pos_D2.empty()){
    ...
    for(auto it = pos_D2.begin();it!=pos_D2.end();++it){
      ...
      h_omega->Write();
      auto h_shmsdp = d_pos_pi.Histo1D({"shmsdp","shmsdp",100,-10,25},"P_gtr_dp","weight");
      h_shmsdp->Write();
      auto h_hmsdp = d_pos_pi.Histo1D({"hmsdp","hmsdp",100,-10,12},"H_gtr_dp","weight");
      h_hmsdp->Write();
      ...
      h_omega_bg->Write();
      auto h_shmsdp_bg = d_pos_bg.Histo1D({"shmsdp_bg","shmsdp_bg",100,-10,25},"P_gtr_dp","weight");
      h_shmsdp_bg->Write();
      auto h_hmsdp_bg = d_pos_bg.Histo1D({"hmsdp_bg","hmsdp_bg",100,-10,12},"H_gtr_dp","weight");
      h_hmsdp_bg->Write();
      ...
      h_xbj_bg->Write();
      auto h_xbj_bg_1 = d_pos_bg_1.Histo1D({"xbj_1_bg","xbj_1_bg",bins,0,1},"xbj","weight");
      auto h_xbj_bg_2 = d_pos_bg_2.Histo1D({"xbj_2_bg","xbj_2_bg",bins,0,1},"xbj","weight");
      auto h_xbj_bg_3 = d_pos_bg_3.Histo1D({"xbj_3_bg","xbj_3_bg",bins,0,1},"xbj","weight");
      h_xbj_bg_1->Write();
      h_xbj_bg_2->Write();
      h_xbj_bg_3->Write();
      auto h_xprime_bg_1 = d_pos_bg_1.Histo1D({"xprime_1_bg","xprime_1_bg",bins,0,1},"xprime","weight");
      auto h_xprime_bg_2 = d_pos_bg_2.Histo1D({"xprime_2_bg","xprime_2_bg",bins,0,1},"xprime","weight");
      auto h_xprime_bg_3 = d_pos_bg_3.Histo1D({"xprime_3_bg","xprime_3_bg",bins,0,1},"xprime","weight");
      h_xprime_bg_1->Write();
      h_xprime_bg_2->Write();
      h_xprime_bg_3->Write();
      ...
      h_x_z_bg_2->Write();
      auto h_x_z_pos_3 = d_pos_pi_3.Histo2D({"x_z_raw3","x_z_raw3",bins,0,1,bins,0,1},"z","xbj","weight");
      h_x_z_pos_3->Write();
    ...
    for(auto it = neg_D2.begin();it!=neg_D2.end();++it){
      ...
      h_omega->Write();
      auto h_shmsdp = d_neg_pi.Histo1D({"shmsdp","shmsdp",100,-10,25},"P_gtr_dp","weight");
      h_shmsdp->Write();
      auto h_hmsdp = d_neg_pi.Histo1D({"hmsdp","hmsdp",100,-10,12},"H_gtr_dp","weight");
      h_hmsdp->Write();
      ...
      h_omega_bg->Write();
      auto h_shmsdp_bg = d_neg_bg.Histo1D({"shmsdp_bg","shmsdp_bg",100,-10,25},"P_gtr_dp","weight");
      h_shmsdp_bg->Write();
      auto h_hmsdp_bg = d_neg_bg.Histo1D({"hmsdp_bg","hmsdp_bg",100,-10,12},"H_gtr_dp","weight");
      h_hmsdp_bg->Write();
