  ...
  for(json::iterator it = j.begin();it!=j.end();++it){
    ...
    g_yield_pos->GetXaxis()->SetLimits(0.2,0.8);
      ...
      for(json::iterator it = j_z.begin();it!=j_z.end();++it){
        ...
        double charge_neg = 0,charge_pos = 0,yield_neg = 0, yield_pos = 0;
      ...
      pt_SHMS->Draw();
      c_x_Q2->Update();
      std::string c_name = "results/statistics/x_Q2_"+std::to_string(xbj).substr(0,4)+"_"+std::to_string(Q2).substr(0,5)+"_statis.png";
