...
//classic way
  ...
  //auto d_cut = d.Filter(cut_zero,"arr_10_4");
  // auto pos0 = d.Histo1D({"pos_0"});
  // auto neg0 = d.Histo1D({"neg_0"});
  //auto pos0 = d.Fill<double>(TH1D("th1d","",100,0,100),{"pos"})
  //auto arr_10_4_before = d.Histo1D({"arr_10_4"});
  //auto arr_10_4_after = d_cut.Hist1D({"arr_10_4"});
  //auto c1 = new TCanvas();
  //   c1->Divide(2,1);
  //   c1->cd(1);
  //   arr_10_4_before->DrawCopy();
  //   c1->cd(2);
  //   arr_10_4_after->DrawCopy();
}
