...
void HMS_PID_RunGroup_calcut(int RunGroup = 0){
  ...
  if(neg_D2.empty() || pos_D2.empty()){std::cout<<"This is not normal production rungroup"<<std::endl;}
    ...
    for(auto it = neg_D2.begin();it!=neg_D2.end();++it){
     ...
     int neg_cal_e_cercut_n = j_cuts["cer_e"].get<int>();
     ...
     int neg_cal_pion_cercut_n = j_cuts["cer_pi"].get<int>();
    ...
    for(auto it = pos_D2.begin();it!=pos_D2.end();++it){
     ...
     int pos_cal_e_cercut_n = j_cuts["cer_e"].get<int>();
     ...
     int pos_cal_pion_cercut_n = j_cuts["cer_pi"].get<int>();
