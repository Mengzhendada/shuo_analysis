...
void SHMS_rf_DE_plots_new(){
  ...
  c_pieff->SaveAs("results/pid/rftime_new/pi_eff_fixedrf.pdf");
  ...
  c_pipurity->SaveAs("results/pid/rftime_new/pi_purity_fixedrf.pdf");
  ...
  gStyle->SetOptFit(0001);
  c_neg_purity->SaveAs("results/pid/rftime_new/pi_purity_fixedrf_neg.pdf");
  ...
  gStyle->SetOptFit(0001);
  c_pos_purity->SaveAs("results/pid/rftime_new/pi_purity_fixedrf_pos.pdf");
  ...
  c_rfcut_2->SaveAs("results/pid/rftime_new/rfcut_high_fixed99.pdf");
  ...
  c_pieff_2->SaveAs("results/pid/rftime_new/pi_eff_fixed99.pdf");
  ...
  c_pipurity_2->SaveAs("results/pid/rftime_new/pi_purity_fixed99.pdf");
