...
void SHMS_rf_DE_plots(){
  ...
  c_pieff->SaveAs("results/pid/rftime/pi_eff_fixedrf.pdf");
  ...
  mg_pipurity->SetMinimum(0.85);
  //mg_pipurity->GetXaxis()->SetLimits(0.99,1.01);
  c_pipurity->BuildLegend(0.75,0.75,0.95,0.95);
  c_pipurity->SaveAs("results/pid/rftime/pi_purity_fixedrf.pdf");
  ...
  g_neg_pipurity->SetMinimum(0.85);
  gStyle->SetOptFit(0001);
  c_neg_purity->SaveAs("results/pid/rftime/pi_purity_fixedrf_neg.pdf");
  TCanvas *c_pos_purity = new TCanvas();
  c_pos_purity->cd();
  g_pos_pipurity->Draw("AP");
  g_pos_pipurity->Fit("pol2","","",2.9,5);
  g_pos_pipurity->SetMaximum(1.01);
  g_pos_pipurity->SetMinimum(0.85);
  gStyle->SetOptFit(0001);
  c_pos_purity->SaveAs("results/pid/rftime/pi_purity_fixedrf_pos.pdf");
  ...
  c_rfcut_2->SaveAs("results/pid/rftime/rfcut_high_fixed99.pdf");
  ...
  c_pieff_2->SaveAs("results/pid/rftime/pi_eff_fixed99.pdf");
  ...
  mg_pipurity_2->SetMinimum(0.85);
  c_pipurity_2->BuildLegend(0.75,0.75,0.95,0.95);
  c_pipurity_2->SaveAs("results/pid/rftime/pi_purity_fixed99.pdf");
