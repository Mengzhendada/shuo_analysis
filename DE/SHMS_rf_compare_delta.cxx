...
void SHMS_rf_compare_delta(){
  ...
  for(int i_dp = 0;i_dp<6;i_dp++){
    ...
    for(int i = 10;i<580;i=i+10){
      ...
      std::string infile_name = "results/pid/rftime/rf_eff_"+std::to_string(RunGroup)+"_compare.json";
    ...
    std::string c_rf_momentum_name = "results/pid/SHMS_rf_momentum_"+std::to_string(i_dp)+".pdf";
    c_rf_momentum->SaveAs(c_rf_momentum_name.c_str());
